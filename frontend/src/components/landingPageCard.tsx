function LandingPageCard ({ icon, title, description } : { icon:React.ReactNode, title:string, description:string }) {
    return (
        <main className="flex flex-col justify-evenly w-full h-72 bg-white border border-gray-400 rounded-2xl px-8 box-border overflow-hidden hover:border-[#008878] hover:scale-105 hover:shadow-[0_0_20px_0px_#00887870] transition-transform duration-700">
