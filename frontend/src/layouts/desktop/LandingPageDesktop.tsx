            ...
            <section className={`flex flex-col justify-center items-center w-full py-28 px-10 gap-16`}>
                <div className="flex flex-col justify-center items-center gap-8">
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-5">
                        <div className="flex flex-col p-5 rounded-xl border border-[#008781]">
                            <div className="flex justify-center items-center w-[50px] h-[50px] rounded-xl bg-[#008781]">
                                <img src="#" alt="icono" />
                            </div>
                        ...
                        <div className="flex flex-col justify-evenly p-5 rounded-xl bg-[#008781]">
                        ...
                        <div className="flex flex-col justify-evenly p-5 rounded-xl border border-[#008781]">
                            <div className="flex justify-center items-center w-[50px] h-[50px] rounded-xl bg-[#008781]">
                                <img src="#" alt="icono" />
                            </div>
