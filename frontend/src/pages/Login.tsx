      ...
      <section aria-label="Autenticación" className="flex w-full max-w-4xl bg-white/95 rounded-2xl shadow-2xl overflow-hidden backdrop-blur-md">
        ...
        <section className="flex-1 p-10" aria-label={isRegister ? "Formulario de registro" : "Formulario de inicio de sesión"}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            {isRegister && (
              <div>
                <label htmlFor="name" className="block text-sm font-semibold text-left text-teal-700 mb-1">
                  Nombre completo
                </label>
            ...
            <div>
              <label htmlFor="email" className="block text-sm text-left font-semibold text-teal-700 mb-1">Correo electrónico</label>
              <div className="relative">
            ...
            <div>
              <label htmlFor="password" className="block text-sm text-left font-semibold text-teal-700 mb-1">Contraseña</label>
              <div className="relative">
